...
def mainIHM():
    ...
    if(langue == 'FR'): img_flag = PhotoImage(file="images_IHM/fr_flag.png").subsample(4, 4)
    if(langue == 'EN'): img_flag = PhotoImage(file="images_IHM/us_flag.png").subsample(4, 4)
...
def modeImage():
    ...
    image = "images_tests/image_1100.png"
